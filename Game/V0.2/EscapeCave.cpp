...
public:
	...
	/*	Animation = (fPlayerVelX / 800.0f);
		...
		//	}
			...
			if ((GetKey(olc::Key::Q).bHeld) && Bouger == 1)
			{
				fPlayerVelX += (bPlayerOnGround ? -25.0f : -15.0f) * fElapsedTime;
				nDirModX = 1 + AvoirObjet;

			}
			if ((GetKey(olc::Key::A).bHeld) && Bouger == 1)
			{
				fPlayerVelX += (bPlayerOnGround ? -25.0f : -15.0f) * fElapsedTime;
				nDirModX = 1 + AvoirObjet;
			}

			if ((GetKey(olc::Key::D).bHeld) && Bouger == 1)
			{
				fPlayerVelX += (bPlayerOnGround ? 25.0f : 15.0f) * fElapsedTime;
			...
			if ((GetKey(olc::Key::SPACE).bHeld) && Bouger == 1)
			{
	...
	/*	// Vérification de la récupération d'item (niveau 5)
		...
		{
			if (GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.0f) != L'.' 
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.0f) != L'P' 
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.0f) != L'F' 
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.0f) != L'K'
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.0f) != L'I'
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.0f) != L'T'
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.0f) != L'O'



				|| GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.9f) != L'.' 
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.9f) != L'P' 
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.9f) != L'F'
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.9f) != L'K'
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.9f) != L'I'
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.9f) != L'T'
				&& GetTile(fNewPlayerPosX + 0.0f, fPlayerPosY + 0.9f) != L'O')
			{
		...
		{
			if (GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.0f) != L'.'
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.0f) != L'F' 
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.0f) != L'K' 
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.0f) != L'P' 
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.0f) != L'I'
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.0f) != L'T'
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.0f) != L'O'


				|| GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.9f) != L'.' 
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.9f) != L'P' 
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.9f) != L'F' 
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.9f) != L'K'
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.9f) != L'I'
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.9f) != L'T'
				&& GetTile(fNewPlayerPosX + 1.0f, fPlayerPosY + 0.9f) != L'O')
			{
		...
		{
			if (GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY) != L'.' 
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY) != L'P' 
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY) != L'F' 
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY) != L'K'
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY) != L'I'
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY) != L'T'
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY) != L'O'


				|| GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY) != L'.' 
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY) != L'P' 
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY) != L'F' 
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY) != L'K'
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY) != L'I'
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY) != L'T'
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY) != L'O')
			{
		...
		else // Descendre
		{
			if (GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY + 1.0f) != L'.' 
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY + 1.0f) != L'P' 
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY + 1.0f) != L'F' 
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY + 1.0f) != L'K' 
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY + 1.0f) != L'I'
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY + 1.0f) != L'T'
				&& GetTile(fNewPlayerPosX + 0.0f, fNewPlayerPosY + 1.0f) != L'O'


				|| GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY + 1.0f) != L'.' 
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY + 1.0f) != L'P' 
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY + 1.0f) != L'F' 
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY + 1.0f) != L'K'
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY + 1.0f) != L'I'
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY + 1.0f) != L'T'
				&& GetTile(fNewPlayerPosX + 0.9f, fNewPlayerPosY + 1.0f) != L'O')
			{
...
//DrawPartialSprite(x * nTileWidth - fTileOffsetX, y * nTileHeight - fTileOffsetY, sprSky.get(), (x + 1) * nTileWidth - fTileOffsetX, (y + 1) * nTileHeight - fTileOffsetY, nTileWidth, nTileHeight);
		...
		*/
		...
		if (Puzzle1 == 1)
		{
			DrawPartialSprite(fPlayerPosX, fPlayerPosY, sprBalancePuzzle, 0 * 192, 0 * 192, 192, 192);
			if ((GetKey(olc::Key::ESCAPE).bHeld) || (GetKey(olc::Key::E).bHeld))
			{
